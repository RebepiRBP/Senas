                  ...
                  <tr key={label} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-4 text-center">
                      <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
                        data.precision >= 0.9 ? 'bg-green-100 text-green-800' :
                        data.precision >= 0.7 ? 'bg-yellow-100 text-yellow-800' :
                    ...
                    <td className="px-4 py-4 text-center">
                      <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
                        data.recall >= 0.9 ? 'bg-green-100 text-green-800' :
                        data.recall >= 0.7 ? 'bg-yellow-100 text-yellow-800' :
                        'bg-red-100 text-red-800'
                      }`}>
                    ...
                    <td className="px-4 py-4 text-center">
                      <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
                        data.f1Score >= 0.9 ? 'bg-green-100 text-green-800' :
                        data.f1Score >= 0.7 ? 'bg-yellow-100 text-yellow-800' :
                        'bg-red-100 text-red-800'
                      }`}>
